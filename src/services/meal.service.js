    ...
    create: async (meal, userId, callback) => {
        ...
        try {
            const result = await query(
                ...
                `VALUES (${meal.isActive}, ${meal.isVega}, ${meal.isVegan}, ${meal.isToTakeHome}, '${meal.dateTime}', ${meal.maxAmountOfParticipants}, ${meal.price}, '${imageURL}', ${userId}, '${meal.createDate}', '${Date.now().toString()}', '${meal.name}', '${meal.description}', '${meal.allergenes}')`,
            );
